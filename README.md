# Deprecated!! [Jack Kerouac's Cartoon Spell Effects](https://github.com/jackkerouac/animated-spell-effects-cartoon) supports the Sequencer Database by itself now.
